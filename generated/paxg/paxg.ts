...
export class FeeControllerSet extends ethereum.Event {
  get params(): FeeControllerSet__Params {
    return new FeeControllerSet__Params(this);
  }
}

export class FeeControllerSet__Params {
  _event: FeeControllerSet;

  constructor(event: FeeControllerSet) {
    this._event = event;
  }

  get oldFeeController(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get newFeeController(): Address {
    return this._event.parameters[1].value.toAddress();
  }
}
...
export class paxg extends ethereum.SmartContract {
  static bind(address: Address): paxg {
    return new paxg("paxg", address);
  }
  ...
  getFeeFor(_value: BigInt): BigInt {
    let result = super.call("getFeeFor", "getFeeFor(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_value)
    ]);
  ...
  try_getFeeFor(_value: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("getFeeFor", "getFeeFor(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_value)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  betaDelegatedTransferBatch(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigIntArray(serviceFee),
  ...
  betaDelegatedTransfer(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(serviceFee),
  ...
  feeParts(): BigInt {
    let result = super.call("feeParts", "feeParts():(uint256)", []);

    return result[0].toBigInt();
  }

  try_feeParts(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("feeParts", "feeParts():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  feeController(): Address {
    let result = super.call("feeController", "feeController():(address)", []);

    return result[0].toAddress();
  }

  try_feeController(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "feeController",
      "feeController():(address)",
      []
  ...
  feeDecimals(): i32 {
    let result = super.call("feeDecimals", "feeDecimals():(uint8)", []);

    return result[0].toI32();
  }

  try_feeDecimals(): ethereum.CallResult<i32> {
    let result = super.tryCall("feeDecimals", "feeDecimals():(uint8)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class ReclaimPAXGCall extends ethereum.Call {
  get inputs(): ReclaimPAXGCall__Inputs {
    return new ReclaimPAXGCall__Inputs(this);
  }

  get outputs(): ReclaimPAXGCall__Outputs {
    return new ReclaimPAXGCall__Outputs(this);
  }
}

export class ReclaimPAXGCall__Inputs {
  _call: ReclaimPAXGCall;

  constructor(call: ReclaimPAXGCall) {
    this._call = call;
  }
}

export class ReclaimPAXGCall__Outputs {
  _call: ReclaimPAXGCall;
...
export class SetFeeControllerCall extends ethereum.Call {
  get inputs(): SetFeeControllerCall__Inputs {
    return new SetFeeControllerCall__Inputs(this);
  }

  get outputs(): SetFeeControllerCall__Outputs {
    return new SetFeeControllerCall__Outputs(this);
  }
}

export class SetFeeControllerCall__Inputs {
  _call: SetFeeControllerCall;

  constructor(call: SetFeeControllerCall) {
    this._call = call;
  }

  get _newFeeController(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetFeeControllerCall__Outputs {
  _call: SetFeeControllerCall;
